...
public class AddEventDialog extends DialogFragment implements Serializable {

    private static final long serialVersionUID = 1140428064440365771L;
    private int day;
    private int month;
    private int year;
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        final View rootView = layoutInflater.inflate(R.layout.add_event_dialog, null);
        ...
        final AlertDialog addEventDialog = builder.show();

        int buttonTextColor = ContextCompat.getColor(getActivity(), R.color.colorAccent);

        final Button positiveButton = addEventDialog.getButton(AlertDialog.BUTTON_POSITIVE);
        positiveButton.setTextColor(buttonTextColor);

        Button negativeButton = addEventDialog.getButton(AlertDialog.BUTTON_NEGATIVE);
        negativeButton.setTextColor(buttonTextColor);
        addEventDialog.getWindow().clearFlags(WindowManager.LayoutParams.FLAG_DIM_BEHIND);
        ...
        addEventDialog.getWindow().setLayout(widthDialog, WindowManager.LayoutParams.WRAP_CONTENT);
        ...
        Button setDateButton = (Button) rootView.findViewById(R.id.addEventSetDateButton);

        setDateButton.getBackground().setColorFilter(ContextCompat.getColor(getActivity(), R.color.colorAccent), PorterDuff.Mode.MULTIPLY);
        ...
        addEventDialog.getButton(AlertDialog.BUTTON_POSITIVE).setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    /**
     * Updates the date text view on the dialog.
     */
